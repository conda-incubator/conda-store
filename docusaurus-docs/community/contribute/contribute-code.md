...
Runtime-required dependencies should be added to the `pyproject.toml` file:
...
We also use [pre-commit.ci](https://pre-commit.com/) to automatically run the pre-commit hooks on every Pull Requests.
