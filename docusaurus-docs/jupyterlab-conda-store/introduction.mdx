...
1. Pre-requisites: [`conda-store-server`][conda-store-server], JupyterLab &gt;= 4.0, and Python &gt;= 3.8
...
[conda-store-server]: /conda-store/how-tos/install-standalone#1-install-the-library
