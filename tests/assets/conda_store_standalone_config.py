...
from conda_store_server.storage import LocalStorage
...
c.CondaStore.store_directory = "/tmp/conda-store/"
c.CondaStore.environment_directory = "/tmp/conda-store-envs/{namespace}-{name}"
# c.CondaStore.database_url = "mysql+pymysql://admin:password@mysql/conda-store"
c.CondaStore.database_url = "sqlite:////Users/pierrot/dev/dev_python/Quansight/conda-store/conda-store-latest/conda-store.sqlite"
...
c.LocalStorage.storage_path = "/tmp/conda-store-storage"
# c.LocalStorage.storage_url
